  ...
  const projects = [
    {
      ...
      title: "CV maker",
      description:
        "A full-stack e-commerce application with real-time cart updates, payment integration, and admin dashboard. Features include product search, filtering, user authentication, and order management.",
      technologies: ["React", "vanilla css", "MongoDB", "Express"],
    ...
    },
    {
      ...
      description:
        "Modern social media analytics dashboard with real-time data visualization, post scheduling, and engagement metrics. Built with responsive design and dark mode support.",
