...
const Project = () => {
  ...
  const projects = [
    ...
    },
    {
      ...
      description:
        "A fully functional web application where sellers can add and sell toys online. Users can browse different toy categories, view detailed information, and manage their listings efficiently. The project uses Firebase Authentication for secure user login and registration, and it’s built entirely with reusable React components to ensure a fast, smooth, and responsive user experience.",
      technologies: ["React", "Express", "MongoDB", "node.js"],
      githubLink: "https://github.com/AB-ohi/Toy-Marketplace-cliend.git",
      liveLink: "https://toy-marketplace-ac51d.web.app",
      components: [
        "https://i.ibb.co.com/v4NLGFn9/screencapture-toy-marketplace-ac51d-web-app-2025-10-28-18-04-53.png",
        "https://i.ibb.co.com/WvyR3VpP/screencapture-toy-marketplace-ac51d-web-app-login-2025-10-28-18-06-08.png",
        "https://i.ibb.co.com/spVQqKyM/screencapture-toy-marketplace-ac51d-web-app-add-Toy-2025-10-28-18-05-26.png",
      ],
    ...
    },
    {
      ...
      title: "Team Project",
      description:
        "Infonexus is a collaborative web platform where users can share and explore innovative business ideas. It allows people to post their startup concepts, receive feedback, and connect with others who share similar interests. The website is designed to encourage creativity and teamwork, helping individuals turn their ideas into potential opportunities through community interaction and support. Built with modern web technologies, Infonexus ensures a smooth, responsive, and engaging user experience.",
      technologies: ["Next.js", "Figma", "Firebase", "Tailwind"],
      githubLink: "https://github.com/itsrazib1/infonexus.git",
      liveLink: "https://infonexus.netlify.app/",
      components: [
